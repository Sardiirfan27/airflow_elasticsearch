...
def preprocessing(): 
    ...
    '''
    # pembisihan data
    data = pd.read_csv("/opt/airflow/dags/irfan_new.csv")

    # bersihkan data 
    data.drop_duplicates(inplace=True)
    data= data.query('age>=0')
    data.to_csv('/opt/airflow/dags/irfan_clean.csv', index=False)
...
with DAG(
    "P2M3_irfan_DAG_hck", #atur sesuai nama project kalian
